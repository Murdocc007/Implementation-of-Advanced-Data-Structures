...
public class QuickSort1<T extends Comparable<T>> {
	...
	/**
	 * 
	 * Highly Inefficient and partially correct. If an array has another element
	 * with same value as the pivot then it will not sort correctly.
	 * 
	 * @param a
	 * @param p
	 * @param r
	...
	private static <T extends Comparable<T>> int partition2(T[] a, int p, int r) {
